...
<<<<<<< HEAD:src/media/glsl/game/terrain-fs.glsl
    vec4 fogColor = vec4(24.0/255.0, 29.0/255.0, 36.0/255.0);
=======
			//float freq = 64.0, phase = -time;
			float freq = 32.0, phase  = 0.0; // * pow(4.0, cos(time/8.0)), phase = 0.0;
>>>>>>> e3e7b81e6f234ad51c78ac05f197d313cf414c87:src/media/glsl/terrain-fs.glsl
